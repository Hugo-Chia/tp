...
| **T**     | Tag Name (a wildcard for clinic receptionist to add any useful tags necessary for work) A suggested use case is adding CHAS/insurance information to the patient. | Optional <br> `add`                                           | Tag names should be alphanumeric, may contain `-` and no spaces.                                                                                                                                                                                                                                                                                                                                                                              |
