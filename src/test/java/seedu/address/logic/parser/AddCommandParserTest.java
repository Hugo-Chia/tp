...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + NRIC_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                new AddCommand(expectedPersonMultipleTags));
    }

    @Test
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + NRIC_DESC_BOB + TAG_DESC_FRIEND;
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + NRIC_DESC_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + NRIC_DESC_BOB + INVALID_TAG_DESC
