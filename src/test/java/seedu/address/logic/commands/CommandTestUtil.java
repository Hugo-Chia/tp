...
public class CommandTestUtil {
    ...
    public static final String VALID_DOB_AMY = "07/05/1978";
    public static final String VALID_DOB_BOB = "15/08/1996";
     ...
     * - a {@code CommandException} is thrown <br>
     * - the CommandException message matches {@code expectedMessage} <br>
     * - the address book and selected person in {@code actualModel} remain unchanged
     */
    public static void assertFilteredCommandFailure(Command command, Model actualModel, String expectedMessage) {
        // we are unable to defensively copy the model for comparison later, so we can
        // only do so by copying its components.
        AddressBook expectedAddressBook = new AddressBook(actualModel.getAddressBook());
